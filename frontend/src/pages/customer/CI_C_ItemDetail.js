    ...
    return (
        <div className={styles['page-container']}>
            ...
            <div className={styles['content']}>
                <button className={styles['back-button']} onClick={() => navigate('/menu')}>
                    ← Back to Menu
                </button>
                <div className={styles['item-container']}>
                    ...
                    <div className={styles['details-container']}>
                        ...
                        <div className={styles['rating-container']}>
                            <span className={styles['rating']}>★ {reviews.averageRating?.toFixed(1) || 'N/A'}</span>
                            <span className={styles['review-count']}>({reviews.totalReviews || 0} reviews)</span>
                        </div>
                        <button 
                            ...
                            <div className={styles['review-card']}>
                                <div className={styles['review-header']}>
                                    <div className={styles['reviewer-info']}>
                                        ...
                                        <span className={styles['review-time']}>{review.createdAt}</span>
                                    </div>
                                </div>
                                {review.comment && (
